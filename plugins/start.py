...
async def start_command(client: Client, message: Message):
    ...
    [
                    ...
                    InlineKeyboardButton('🍁 Dᴇᴠᴇʟᴏᴘᴇʀ', url='https://t.me/Straw_Hat_Bots')
...
async def not_joined(client: Client, message: Message):
    buttons = [
        [
            InlineKeyboardButton(text="⚠️ ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ", url=client.invitelink2),
            InlineKeyboardButton(text="ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ ⚠️", url=client.invitelink3),
        ],
        [
